...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=2]
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1,0) rectangle (tr -| 3,0);
            \end{scope}
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\section{Worked example: monoids}
...
\begin{frame}
    ...
    \begin{equation*}
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
             %Coordinate layout and vertex positioning
            \path
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1,0) rectangle (top -| 4,0);
            \end{scope}
        \end{tikzpicture}
        :=
        \only<4-4>{
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(tl)$)]
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dll -| -1,0) rectangle (tr -| 4,0);
            \end{scope}
        \end{tikzpicture}
        }
        \only<5-5>{
    ...
    \only<11->{
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(tl)$)]
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dlll -| -1,0) rectangle (tr -| 6,0);
            \end{scope}
        \end{tikzpicture}\\
        \uncover<13->{
        &=
...
\begin{frame}
    \frametitle{Monoid homomorphisms}
    \begin{definition}
        Let \((M, \mu, e), (M', \mu', e')\) be monoids.
        A function \(f : M \to M'\) is a monoid homomorphism if
        \begin{itemize}
            \item
                for any \(a, b \in M\), \(f(a * b) = f(a) *' f(b)\),
            \item
                and \(f(e) = e'\).
        \end{itemize}
    \end{definition}
    ...
    \begin{example}
        \begin{itemize}
            \item
                From \((\NN, +, 0)\) to \((\NN, *, 1)\), map \(n \mapsto 2^n\).
            \item
                From \((\RR, *, 1)\) to \((\mathrm{Mat}_n, *, I_n)\), map \(x \mapsto x I_n\).
            \item
                From \((\ZZ_4, +, 0)\) to \((S^1, *, 1)\), send \(n \mapsto e^{\frac{n \pi i}{2}}\).
        \end{itemize}
    \end{example}
    }
\end{frame}
...
\begin{frame}
    \frametitle{Homomorphisms diagramatically}
    A function \(f : M \to M'\) is a homomorphism if:
    ...
    \begin{equation*}
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(1,0) coordinate[label=below:\(M\)] (dr)
                +(0.5,1) coordinate[dot, label=below:\(\mu\)] (a)
                +(0.5,2) coordinate[dot, label=right:\(f\)] (b)
                +(0.5,3) coordinate[label=above:\(M'\)] (top);
            % Line drawing
            \draw (dl) to[out=90, in=180] (a) to[out=0, in=90] (dr);
            \draw (a) -- (b);
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1,0) rectangle (top -| 2,0);
            \end{scope}
        \end{tikzpicture}
        =
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                coordinate[label=below:\(M\)] (dl)
                +(1,0) coordinate[label=below:\(M\)] (dr)
                +(0,1) coordinate[dot, label=left:\(f\)] (a)
                +(1,1) coordinate[dot, label=right:\(f\)] (b)
                +(0.5,2) coordinate[dot, label=below:\(\mu\)] (c)
                +(0.5,3) coordinate[label=above:\(M'\)] (top);
            % Line drawing
            \draw (dl) -- (a);
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
            ...
            \path
                coordinate[] (bot)
                +(0,1) coordinate[dot, label=below:\(e\)] (a)
                +(0,2) coordinate[dot, label=right:\(f\)] (b)
                +(0,3) coordinate[label=above:\(M'\)] (top);
            % Line drawing
            \draw (a) -- (top);
            % Region filling
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
            ...
            \path
                coordinate[] (bot)
                +(0,1) coordinate[dot, label=below:\(e'\)] (a)
                +(0,2) coordinate[label=above:\(M'\)] (top);
            % Line drawing
            \draw (a) -- (top);
            % Region filling
            \begin{scope}[on background layer]
    ...
    \begin{equation*}
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                coordinate[] (dl)
                +(1,0) coordinate[] (dr)
                +(0.5,1) coordinate[dot] (a)
                +(0.5,2) coordinate[dot, label=right:\(f\)] (b)
                +(0.5,3) coordinate[dot, label=right:\(g\)] (c)
                +(0.5,4) coordinate[] (top);
            % Line drawing
            \draw (dl) to[out=90, in=180] (a) to[out=0, in=90] (dr);
            \draw (a) -- (b);
            \draw (b) -- (c);
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(0,1) coordinate[dot, label=left:\(f\)] (a)
                +(1,1) coordinate[dot, label=right:\(f\)] (b)
                +(0.5,2) coordinate[dot] (c)
                +(0.5,3) coordinate[dot, label=right:\(g\)] (d)
                +(0.5,4) coordinate[] (top);
            % Line drawing
            \draw (dl) -- (a);
            \draw (dr) -- (b);
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(0,1) coordinate[dot, label=left:\(f\)] (a)
                +(1,1) coordinate[dot, label=right:\(f\)] (b)
                +(0,2) coordinate[dot, label=left:\(g\)] (c)
                +(1,2) coordinate[dot, label=right:\(g\)] (d)
                +(0.5,3) coordinate[dot] (e)
                +(0.5,4) coordinate[] (top);
            % Line drawing
            \draw (dl) -- (a) -- (c);
            \draw (dr) -- (b) -- (d);
            \draw (c) to[out=90, in=180] (e) to[out=0, in=90] (d);
            \draw (e) -- (top);
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1,0) rectangle (top -| 2,0);
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
            ...
            \path
                ...
                +(0,1) coordinate[dot, label=below:\(e\)] (a)
                +(0,2) coordinate[dot, label=right:\(f\)] (b)
                +(0,3) coordinate[dot, label=right:\(g\)] (c)
                +(0,4) coordinate[] (top);
            % Line drawing
            \draw (a) -- (top);
            % Region filling
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
            ...
            \path
                coordinate[] (bot)
                +(0,1) coordinate[dot, label=below:\(e'\)] (a)
                +(0,2) coordinate[dot, label=right:\(g\)] (c)
                +(0,4) coordinate[] (top);
            % Line drawing
            \draw (a) -- (top);
            % Region filling
...
\begin{frame}
    Is \(f = \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(tl)$)]
             %Coordinate layout and vertex positioning
            \path
                coordinate[label=below:\(M\)] (dl)
                +(1,0) coordinate[label=below:\(M'\)] (dr)
                +(1,1) coordinate[dot, red] (a)
                +(0,2) coordinate[label=above:\(M\)] (tl);
            % Line drawing
            \draw[blue] (dl) -- (tl);
            \draw[red] (dr) -- (a);
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1,0) rectangle (tl -| 2,0);
            \end{scope}
        \end{tikzpicture}
    \) a homomorphism?
    \uncover<2->{
    ...
    \begin{equation*}
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(tl)$)]
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1,0) rectangle (tl -| 4,0);
            \end{scope}
        \end{tikzpicture}
        =
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(tl)$)]
            ...
            \path
                ...
                +(3,0) coordinate[] (drr)
                +(0,1) coordinate[] (a)
                +(1,1) coordinate[dot, red] (b)
                +(2,1) coordinate[] (c)
                +(3,1) coordinate[dot, red] (d)
                +(1,2) coordinate[dot, blue] (e)
                +(1,3) coordinate[] (tl);
            % Line drawing
            \draw[blue] (dll) -- (a);
            \draw[red] (dl) -- (b);
    ...
    \begin{equation*}
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
            ...
            \path
                coordinate[] (bot)
                +(0,1) coordinate[dot, label=below:\(e^\times\)] (a)
                +(0,2) coordinate[dot, label=right:\(f\)] (b)
                +(0,3) coordinate[] (top);
            % Line drawing
            \draw (a) -- (top);
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(tl)$)]
            ...
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (bot -| -1,0) rectangle (tl -| 3,0);
            \end{scope}
        \end{tikzpicture}
        =
        \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
...
\begin{frame}
    \only<-2>{
    Is \(f = \begin{tikzpicture}[scale=0.5, baseline=($(bot)!0.5!(top)$)]
         %Coordinate layout and vertex positioning
        \path
            coordinate[label=below:\(M\)] (bot)
            +(0,1) coordinate[dot, label=above:\(\Delta\)] (a)
            +(-0.5,2) coordinate[] (b)
            +(0.5,2) coordinate[] (c)
            +(0,3) coordinate[dot, label=below:\(\mu\)] (d)
            +(0,4) coordinate[label=above:\(M\)] (top);
        % Line drawing
        \draw (bot) -- (a);
        \draw (b) to[out=-90, in=180] (a) to[out=0, in=-90] (c);
        \draw (b) to[out=90, in=180] (d) to[out=0, in=90] (c);
        \draw (d) -- (top);
        % Region filling
        \begin{scope}[on background layer]
        \fill[bg] (bot -| -1,0) rectangle (top -| 1,0);
        \end{scope}
    \end{tikzpicture}\) a homomorphism? (Equationally, \(f(m) = m^2\).)
    \uncover<2->{
    Well...
    ...
    \begin{equation*}
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(1,0) coordinate[label=below:\(M\)] (dr)
                +(0.5,1) coordinate[dot, label=below:\(\mu\)] (a)
                +(0.5,2) coordinate[dot, label=above:\(\Delta\)] (b)
                +(0,3) coordinate[] (c)
                +(1,3) coordinate[] (d)
                +(0.5,4) coordinate[dot, label=below:\(\mu\)] (e)
                +(0.5,5) coordinate[label=above:\(M\)] (top);
            % Line drawing
            \draw (dl) to[out=90, in=180] (a) to[out=0, in=90] (dr);
            \draw (a) -- (b);
            \draw (c) to[out=-90, in=180] (b) to[out=0, in=-90] (d);
            \draw (c) to[out=90, in=180] (e) to[out=0, in=90] (d);
            \draw (e) -- (top);
            % Region filling
            \begin{scope}[on background layer]
    ...
    \begin{equation*}
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(2,0) coordinate[label=below:\(M\)] (dr)
                +(0,1) coordinate[dot, label=above:\(\Delta\)] (a)
                +(2,1) coordinate[dot, label=above:\(\Delta\)] (b)
                +(-0.5,2) coordinate[] (c)
                +(0.5,2) coordinate[] (d)
                +(1.5,2) coordinate[] (e)
                +(2.5,2) coordinate[] (f)
                +(0,3) coordinate[dot, label=below:\(\mu\)] (g)
                +(2,3) coordinate[dot, label=below:\(\mu\)] (h)
                +(1,4) coordinate[dot, label=below:\(\mu\)] (i)
                +(1,5) coordinate[label=above:\(M'\)] (top);
            % Line drawing
            \draw (dl) -- (a);
            \draw (dr) -- (b);
            \draw (c) to[out=-90, in=180] (a) to[out=0, in=-90] (d);
            \draw (e) to[out=-90, in=180] (b) to[out=0, in=-90] (f);
            \draw (c) to[out=90, in=180] (g) to[out=0, in=90] (d);
            \draw (e) to[out=90, in=180] (h) to[out=0, in=90] (f);
            \draw (g) to[out=90, in=180] (i) to[out=0, in=90] (h);
            \draw (i) -- (top);
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dl -| -1.5,0) rectangle (top -| 3.5,0);
            \end{scope}
        \end{tikzpicture}
    \end{equation*}
    \end{minipage}
    ...
    \begin{align*}
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                coordinate[label=below:\(M\)] (dl)
                +(2,0) coordinate[label=below:\(M\)] (dr)
                +(1,1) coordinate[dot, label=above:\(\Delta\)] (a)
                +(-0.5,2) coordinate[] (c)
                +(0.5,2) coordinate[] (d)
                +(1.5,2) coordinate[] (e)
                +(2.5,2) coordinate[] (f)
                ...
                +(1,5) coordinate[label=above:\(M\)] (top);
            % Line drawing
            \draw (dl) to[out=90, in=180] (a);
            \draw (dr) to[out=90, in=0] (a);
            \draw (c) to[out=-90, in=180] (a) to[out=0, in=-90] (e);
            \draw (d) to[out=-90, in=180] (a) to[out=0, in=-90] (f);
            \draw (c) to[out=90, in=180] (g) to[out=0, in=90] (d);
            \draw (e) to[out=90, in=180] (h) to[out=0, in=90] (f);
            \draw (g) to[out=90, in=180] (i) to[out=0, in=90] (h);
            \draw (i) -- (top);
        ...
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \draw (dr) -- (b);
            \draw (c) to[out=-90, in=180] (a) to[out=0, in=-90] (e);
            \draw (d) to[out=-90, in=180] (b) to[out=0, in=-90] (f);
            \draw (c) to[out=90, in=180] (g) to[out=0, in=90] (d);
            \draw (e) to[out=90, in=180] (h) to[out=0, in=90] (f);
            \draw (g) to[out=90, in=180] (i) to[out=0, in=90] (h);
            \draw (i) -- (top);
...
\begin{frame}
    ...
    \only<1-1>{
    Let \(M\) be a set with two monoid structures \((M, \circ, e), (M, \otimes, e')\) so that
    \[
    ...
    \begin{equation*}
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(2,0) coordinate[] (dr)
                +(3,0) coordinate[] (drr)
                +(0.5,1) coordinate[dot, blue] (a)
                +(2.5,1) coordinate[dot, blue] (b)
                +(1.5,2) coordinate[dot, red] (c)
                +(1.5,3) coordinate[] (top);
            % Line drawing
            \draw (dll) to[out=90, in=180] (a) to[out=0, in=90] (dl);
            \draw (dr) to[out=90, in=180] (b) to[out=0, in=90] (drr);
            \draw (a) to[out=90, in=180] (c) to[out=0, in=90] (b);
            \draw (c) -- (top);
            % Region filling
            \begin{scope}[on background layer]
            \fill[bg] (dll -| -1,0) rectangle (top -| 4,0);
            \end{scope}
        \end{tikzpicture}
        =
        \begin{tikzpicture}[scale=0.5, baseline=($(dl)!0.5!(top)$)]
            ...
            \path
                ...
                +(2,0) coordinate[] (dr)
                +(3,0) coordinate[] (drr)
                +(0.5,1) coordinate[dot, red] (a)
                +(2.5,1) coordinate[dot, red] (b)
                +(1.5,2) coordinate[dot, blue] (c)
                +(1.5,3) coordinate[] (top);
            % Line drawing
        ...
        \end{tikzpicture}
    \end{equation*}
    Then \(e = e'\), \(\circ = \otimes\), and \(M\) is commutative.
    }
    \only<2->{
    \begin{proof}
        \uncover<3->{
        \begin{equation*}
            \begin{tikzpicture}[scale=0.25, baseline=($(bot)!0.5!(top)$)]
                 %Coordinate layout and vertex positioning
                \path
                    coordinate[] (bot)
                    +(0,1) coordinate[dot, red] (a)
                    +(0,2) coordinate[] (top);
                % Line drawing
                \draw (a) -- (top);
                % Region filling
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(bot)!0.5!(top)$)]
                ...
                % Region filling
                \begin{scope}[on background layer]
                \fill[bg] (bot -| -1,0) rectangle (top -| 3,0);
                \end{scope}
            \end{tikzpicture}
            =
            \begin{tikzpicture}[scale=0.25, baseline=($(bot)!0.5!(top)$)]
                ...
                \path
                    coordinate[] (bot)
                    +(0,1) coordinate[dot, blue] (a)
                    +(1,1) coordinate[dot, red] (b)
                    +(2,1) coordinate[dot, red] (c)
                    +(3,1) coordinate[dot, blue] (d)
                    +(0.5,2) coordinate[dot, blue] (e)
                    +(2.5,2) coordinate[dot, blue] (f)
                    +(1.5,3) coordinate[dot, red] (g)
                    +(1.5,4) coordinate[] (top);
                % Line drawing
                \draw (a) to[out=90, in=180] (e) to[out=0, in=90] (b);
                \draw (c) to[out=90, in=180] (f) to[out=0, in=90] (d);
                \draw (e) to[out=90, in=180] (g) to[out=0, in=90] (f);
                \draw (g) -- (top);
                % Region filling
                \begin{scope}[on background layer]
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(bot)!0.5!(top)$)]
                ...
                \path
                    ...
                    +(2,1) coordinate[dot, red] (c)
                    +(3,1) coordinate[dot, blue] (d)
                    +(0.5,2) coordinate[dot, red] (e)
                    +(2.5,2) coordinate[dot, red] (f)
                    +(1.5,3) coordinate[dot, blue] (g)
                    +(1.5,4) coordinate[] (top);
                % Line drawing
                \draw (a) to[out=90, in=180] (e) to[out=0, in=90] (c);
                \draw (b) to[out=90, in=180] (f) to[out=0, in=90] (d);
                \draw (e) to[out=90, in=180] (g) to[out=0, in=90] (f);
                \draw (g) -- (top);
                % Region filling
                \begin{scope}[on background layer]
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(bot)!0.5!(top)$)]
                ...
                \path
                    coordinate[] (bot)
                    +(0,1) coordinate[dot, blue] (a)
                    +(2,1) coordinate[dot, blue] (b)
                    +(1,2) coordinate[dot, blue] (c)
                    +(1,3) coordinate[] (top);
                % Line drawing
                \draw (a) to[out=90, in=180] (c) to[out=0, in=90] (b);
                \draw (c) -- (top);
        ...
        \uncover<4->{
        \begin{align*}
            \begin{tikzpicture}[scale=0.25, baseline=($(dl)!0.5!(top)$)]
                 %Coordinate layout and vertex positioning
                \path
                    coordinate[] (dl)
                    +(2,0) coordinate[] (dr)
                ...
                % Region filling
                \begin{scope}[on background layer]
                \fill[bg] (dl -| -1,0) rectangle (top -| 3,0);
                \end{scope}
            \end{tikzpicture}
            &=
            \begin{tikzpicture}[scale=0.25, baseline=($(dl)!0.5!(top)$)]
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(dl)!0.5!(top)$)]
                ...
                \draw (dl) -- (b);
                \draw (dr) -- (c);
                \draw (e) to[out=0, in=90] (c);
                \draw (b) to[out=90, in=180] (f);
                \draw (e) to[out=90, in=180] (g) to[out=0, in=90] (f);
                \draw (g) -- (top);
                % Region filling
                \begin{scope}[on background layer]
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(dl)!0.5!(top)$)]
                ...
                \path
                    ...
                    +(0,1.5) coordinate[] (a)
                    +(3,1.5) coordinate[] (b)
                    +(1,2.5) coordinate[dot] (c)
                    +(2,2.5) coordinate[dot] (d)
                    +(0.5,3.5) coordinate[dot, red] (e)
                    +(2.5,3.5) coordinate[dot, red] (f)
                    +(1.5,4.5) coordinate[dot, blue] (g)
                    +(1.5,5) coordinate[] (top);
                % Line drawing
                \draw (dr) to[out=90, in=-45] (a) to[out=90, in=180] (e) to[out=0, in=90] (c);
                \draw (d) to[out=90, in=180] (f) to[out=0, in=90] (b) to[out=-135, in=90] (dl);
                \draw (e) to[out=90, in=180] (g) to[out=0, in=90] (f);
                \draw (g) -- (top);
                % Region filling
                \begin{scope}[on background layer]
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(dl)!0.5!(top)$)]
                ...
                \path
                    ...
                    +(1,2.5) coordinate[dot] (c)
                    +(2,2.5) coordinate[dot] (d)
                    +(0.5,3.5) coordinate[dot, blue] (e)
                    +(2.5,3.5) coordinate[dot, blue] (f)
                    +(1.5,4.5) coordinate[dot, red] (g)
                    +(1.5,5) coordinate[] (top);
                % Line drawing
                \draw (dr) to[out=90, in=-45] (a) to[out=90, in=180] (e) to[out=0, in=90] (d);
                \draw (c) to[out=90, in=180] (f) to[out=0, in=90] (b) to[out=-135, in=90] (dl);
                \draw (e) to[out=90, in=180] (g) to[out=0, in=90] (f);
                \draw (g) -- (top);
                % Region filling
                \begin{scope}[on background layer]
            ...
            \begin{tikzpicture}[scale=0.25, baseline=($(dl)!0.5!(top)$)]
                ...
                \path
                    ...
                    +(0,1.5) coordinate[] (a)
                    +(2,1.5) coordinate[] (b)
                    +(1,2.5) coordinate[dot, red] (g)
                    +(1,3.5) coordinate[] (top);
                % Line drawing
                \draw (dr) to[out=90, in=-45] (a) to[out=90, in=180] (g) to[out=0, in=90] (b) to[out=-135, in=90] (dl);
                \draw (g) -- (top);
                % Region filling
                \begin{scope}[on background layer]
                \fill[bg] (dl -| -1,0) rectangle (top -| 3,0);
            ...
            \end{tikzpicture}
        \end{align*}
        So \(b \otimes a = b \circ a\) and \(a \otimes b = b \otimes a\) for all \(a, b \in M\).
        }
    \end{proof}
    }
\end{frame}
